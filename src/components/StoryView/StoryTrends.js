...
const StoryTrends = () => {
	return(
      ...
      > <svg>
          ...
          <line strokeWidth={2} stroke={'#4a4a4a'} width={600} height={30} x1={100} x2={500} y1={260} y2={260} marker-end="url(#arrow)"/>
      	</svg>
        <XAxis dataKey="name" stroke="transparent" tick={<CustomizedTick  data={graphData} />} />
      	<YAxis hide />
      	<Tooltip />
